...
export const Paths = {
  loginPath : "http://localhost:92/api/Login/UserLogin/",
  reportPath : "http://localhost:92/api/Claim/GetClaimReport",
  claimPath: "http://localhost:92/api/Claim/GetClaim",
  
  
  attributes: "http://localhost:92/api/Attribute/GetAllAttributeID",
  attribute: "http://localhost:92/api/Attribute/GetAttributeDetails?attributeId=",
  attributeAdd: "http://localhost:92/api/Attribute/AddAttributes", 
  attributeUpdate: "http://localhost:92/api/Attribute/UpdateAttributes",
  attributeGroup: "http://localhost:92/api/Attribute/GetAttributeGroup",

  benefits: "http://localhost:92/api/Benefits/GetAllBenefitsID",
  benefit: "http://localhost:92/api/Benefits/GetBenefitsdetail/",
  benefitAdd: "http://localhost:92/api/Benefits/AddBenefits",
  benefitUpdate: "http://localhost:92/api/Benefits/UpdateBenefits",

  programs: "http://localhost:92/api/Programs/GetAllProgramsID",
  program: "http://localhost:92/api/Programs/GetProgramDetail/",
  programAdd: "http://localhost:92/api/Programs/AddPrograms",
  programUpdate: "http://localhost:92/api/Programs/UpdatePrograms",

  contracts: "http://localhost:92/api/Contracts/GetAllContractsID/",
  contractsByClientPath: "http://localhost:92/api/Contracts/GetAllContractsID/",
  contract: "http://localhost:92/api/Contracts/GetContracts/",
  contractAdd: "http://localhost:92/api/Contracts/AddContracts",
  contractUpdate: "http://localhost:92/api/Contracts/UpdateContracts",
  contractAll: "http://localhost:92/api/Contracts/GetAllContracts",
 contractDateValidation: "http://localhost:92/api/Contracts/DateValidation/",

  clients: "http://localhost:92/api/Clients/LoadClientDetails",
  client: "http://localhost:92/api/Clients/GetClientDetails/",
  clientAdd: "http://localhost:92/api/Clients/AddClients",
  clientUpdate: "http://localhost:92/api/Clients/UpdateClients",
  getClientDetails: "http://localhost:92/api/Clients/GetClientDetails/",
  activeClients:"http://localhost:92/api/Clients/GetActiveClients",
  parentClient:"http://localhost:92/api/Clients/GetParentClient",
    duplicateClientId: "http://localhost:92/api/Clients/DuplicateClientID?clientId=",
    duplicateClientName: "http://localhost:92/api/Clients/DuplicateClient?client=",



  roles: "http://localhost:92/api/Roles/GetAllRoles",
  role: "http://localhost:92/api/Roles/GetRolesDetail/",
  roleAdd: "http://localhost:92/api/Roles/AddRoles",
  roleUpdate: "http://localhost:92/api/Roles/UpdateRoles",

  rules: "http://localhost:92/api/Rules/GetAllRuleID",
  rule: "http://localhost:92/api/Rules/GetRulesDetails?ruleId=",
  ruleGroups: "http://localhost:92/api/Rules/GetRuleGroup", 
  ruleAdd: "http://localhost:92/api/Rules/AddRules",
  ruleUpdate: "http://localhost:92/api/Rules/UpdateRules",
  
  claimCalculate: "http://localhost:92/api/Claim/CalculateClaimAmount/",

  UsersPath:"http://localhost:92/api/UserAdministration/GetAllUsers",
  UserDetailPath:"http://localhost:92/api/UserAdministration/GetUserDetails/",
  userAdd:"http://localhost:92/api/UserAdministration/AddUsers",
  userTerminate:"http://localhost:92/api/UserAdministration/TerminateUsers",
  userChange:"http://localhost:92/api/UserAdministration/ChangeUsers",
 
  BatchStatusPath:"http://localhost:92/api/BatchProcess/GetBatchStatus",
  BatchProcessPath:"http://localhost:92/api/BatchProcess/GetBatchProcessDetail/",
  BatchHistoryPath:"http://localhost:92/api/BatchProcess/GetBatchProcessHistoryDetail?batchProcessId=",
  BatchProcessAdd: "http://localhost:92/api/BatchProcess/AddBatchProcess",
  BatchProcessUpdate: "http://localhost:92/api/BatchProcess/UpdateBatchProcess",
  BatchProcessCalculate: "http://localhost:92/api/BatchProcess/BatchCalculateClaimAmount?",

  planTires: "http://localhost:92/api/Plan/GetTiers",
  planAll: "http://localhost:92/api/Plan/GetPlanDetails",
  planAdd: "http://localhost:92/api/Plan/AddPlan",
  planUpdate: "http://localhost:92/api/Plan/UpdatePlan",

  memberSearch: "http://localhost:92/api/Member/GetMemberdetail?",
  memberAdd: "http://localhost:92/api/Member/AddMember",
  memberUpdate: "http://localhost:92/api/Member/UpdateMember",
    memberAll: "http://localhost:92/api/Member/GetAllMember",
    member:"http://localhost:92/api/Member/GetMemberDetailsByClientId/",
  

  productAll: "http://localhost:92/api/Product/GetAllProducts",
  product: "http://localhost:92/api/Product/GetProducts?productId=",
  productAdd: "http://localhost:92/api/Product/AddProducts",
  productUpdate:"http://localhost:92/api/Product/UpdateProduct",
  productCovertClaims:"http://localhost:92/api/Product/GetCoveredClaims",

 ExcelUploadPath: "http://localhost:92/api/ExcelUpload/UploadExcel?userId=",
