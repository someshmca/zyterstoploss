...
@Component({
  selector: 'app-lasering-search',
  templateUrl: './lasering-search.component.html',
  styleUrls: ['./lasering-search.component.css'],
  providers: [DatePipe]
})
export class LaseringSearchComponent implements OnInit {
